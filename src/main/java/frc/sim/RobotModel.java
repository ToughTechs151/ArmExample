 ...
 *
 * <p>Provides realistic simulation of robot mechanics including elevator, arm, and roller systems.
...
public class RobotModel {
  ...
  public RobotModel(Robot robot) {
    ...
    armModel = new ArmModel(robot.getRobotContainer().getArmSubsystem());
