...
public class RobotContainer {
  ...
  private CommandXboxController driverController =
      new CommandXboxController(OIConstants.CONTROLLER_PORT);

  // Now all the subsystems.

  private final ArmSubsystem armSubsystem = new ArmSubsystem(ArmSubsystem.initializeHardware());
  ...
  private void configureButtonBindings() {
    ...
    // Commands to extend and retract the arm when A and B are pressed on the driver's controller
    driverController.a().onTrue(armSubsystem.extendArmCommand());
    driverController.b().onTrue(armSubsystem.retractArmCommand());
  }
